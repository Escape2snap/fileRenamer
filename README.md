...
# 使用 SHA-256，递归处理所有 .go 文件
./fileRenamer -hash SHA-256 -r -e '\.go$'
...
| 算法 | CLI 名称（大小写不敏感） | 完整长度（hex） |
|------|--------------------------|----------------|
| SHA3-224 | `sha3-224` | 56 |
| SHA3-256 | `sha3-256` | 64 |
| SHA3-384 | `sha3-384` | 96 |
| SHA3-512 | `sha3-512` | 128 |
| SHA-224 | `sha-224` / `sha224` | 56 |
| SHA-256 | `sha-256` / `sha256` | 64 |
| SHA-384 | `sha-384` / `sha384` | 96 |
| SHA-512 | `sha-512` / `sha512` | 128 |
| SHA-512/224 | `sha-512/224` | 56 |
| SHA-512/256 | `sha-512/256` | 64 |
